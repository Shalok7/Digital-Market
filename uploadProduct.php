					  ...
					  <div class="col-sm-6">
						  <div class="select-wrapper" style="width: auto" >
							  <select name="type" id="type" required style="background-color:white;color: black;">
								  ...
								  <option value="Vegetable" style="color: black;">Electronics</option>
								  <option value="Vegetable" style="color: black;">digital</option>
								  <option value="Vegetable" style="color: black;">vehicals</option>
								  <option value="Vegetable" style="color: black;">kids section</option>
								  <option value="Vegetable" style="color: black;">clothes</option>


								  <option value="Vegetable" style="color: black;">Vegetable</option>
								  <option value="Grains" style="color: black;">gadgets</option>
							  </select>
						</div>
					  </div>
					  <div class="col-sm-6">
