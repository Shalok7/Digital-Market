...
<footer class="footer-distributed" style="background-color:black" id="aboutUs">
	...
	<div class="footer-left">
		<h3 style="font-family: 'Times New Roman', cursive;">Buy and Sell Goods &copy; </h3>
		<!--	<div class="logo">
	...
	<div class="footer-center">
		<div>
			...
			<p style="font-size:20px">Buy and Sell Good Fam<span>Chennai</span></p>
		</div>
		<div>
			<i class="fa fa-phone"></i>
			<p style="font-size:20px">8918907805</p>
		</div>
		<div>
			<i class="fa fa-envelope"></i>
			<p style="font-size:20px"><a href="mailto:agroculture@gmail.com"
					style="color:white">supriyosarkar339@gmail.com</a></p>
		</div>
	</div>

	<div class="footer-right">
		<p class="footer-company-about" style="color:white">
			<span style="font-size:20px"><b>About Buy and Sell Goods</b></span>
			Buy and Sell Good is e-commerce trading platform for grains & grocerries...
		</p>
		...
		<div class="container">
			...
			<form method="post" action="Login/login.php">
				<div class="row uniform 50%">
					...
					<div class="7u$">
						<input type="password" name="pass" id="pass" value="" placeholder="Password" style="width:80%"
							required />
					</div>
				</div>
				<div class="row uniform">
					...
					<div class="3u 12u$(small)">
						<input type="radio" id="login_farmer" name="category" value="1" checked>
						<label for="login_farmer">Seller</label>
					</div>
					<div class="3u 12u$(small)">
						<input type="radio" id="login_buyer" name="category" value="0">
		...
		<div class="container">
			<section>
				...
				<center>
					...
					<div class="row uniform">
						<div class="6u 12u$(xsmall)">
							<input type="text" name="addr" id="addr" value="" placeholder="Address" style="width:80%"
								required />
						</div>
					</div>
					<div class="row uniform">
						...
						<div class="3u 12u$(small)">
							...
							<label for="signup_farmer">Seller</label>
						</div>
						<div class="3u 12u$(small)">
							<input type="radio" id="signup_buyer" name="category" value="0">
